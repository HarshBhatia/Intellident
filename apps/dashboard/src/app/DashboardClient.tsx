                ...
                <div className="bg-white dark:bg-gray-900 p-5 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm transition-all hover:shadow-md group">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            {isInitialLoad ? <Skeleton className="h-6 w-12 mt-1" /> : <p className="text-2xl font-black text-gray-900 dark:text-white leading-tight">{stats.totalPatients}</p>}
                        </div>
                    </div>
                </div>
                <div className="bg-white dark:bg-gray-900 p-5 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm transition-all hover:shadow-md group">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            {isInitialLoad ? <Skeleton className="h-6 w-12 mt-1" /> : <p className="text-2xl font-black text-gray-900 dark:text-white leading-tight">
                ...
                <div className="bg-white dark:bg-gray-900 p-5 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm transition-all hover:shadow-md group">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            {isInitialLoad ? <Skeleton className="h-6 w-12 mt-1" /> : <p className="text-2xl font-black text-gray-900 dark:text-white leading-tight">{stats.doctorsCount}</p>}
                        </div>
                    </div>
                </div>
            </div>
