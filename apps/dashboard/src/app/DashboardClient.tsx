      ...
      <main style={{ maxWidth: 1400, margin: '0 auto', padding: '24px 24px 40px' }}>
        ...
        <div className="flex items-end justify-between mb-6 flex-wrap gap-4">
          ...
          <div className="flex gap-2">
            ...
            <button onClick={() => router.push('/patients?new=1')} className="inline-flex items-center gap-1.5 px-3 py-2 text-sm font-semibold bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition">
        ...
        <div className="grid gap-4 mb-4" style={{ gridTemplateColumns: '1.4fr 1fr 1fr' }}>
          ...
          <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-5">
            <div className="flex items-center justify-between mb-3">
              ...
              <button onClick={() => router.push('/patients')} className="text-xs font-semibold text-blue-600 dark:text-blue-400 hover:underline">All patients →</button>
            </div>
