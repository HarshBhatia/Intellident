...
export default function PatientTable({ patients, onAddClick, onDeleteSuccess }: PatientTableProps) {
  ...
  return (
    <div className="overflow-hidden border border-gray-200 dark:border-gray-800 rounded-xl shadow-sm bg-white dark:bg-gray-900 transition-colors">
          ...
          <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
            {paginatedPatients.map((patient) => (
              ...
              >
                ...
                <td className="px-6 py-4 whitespace-nowrap font-mono text-xs">{patient.phone_number || '-'}</td>
                <td className="px-6 py-4 whitespace-nowrap">
                  {patient.last_visit ? (
