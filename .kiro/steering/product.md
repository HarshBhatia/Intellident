...
- Appointment scheduling with calendar view and time slot management
- Financial management (payments and expenses with categories)
...
- Role-based access control (OWNER, DOCTOR roles)
